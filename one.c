...
#endif
			printf("input w i:%d, j:%d %lf\n", i, j, inpuLayer[i].weight[j]);
...
#else
			hideLayer[i].weight[j] = 1;
#endif
			printf("hide w i:%d j:%d %lf\n", i, j, hideLayer[i].weight[j]);
			hideLayer[i].weight_delta[j] = 0.0;
		}
	}
	hideLayer[0].weight[0] = 0.823400  ;
	hideLayer[1].weight[0] = 0.122400  ;
	hideLayer[2].weight[0] = 0.145800  ;
	hideLayer[3].weight[0] = -0.848400 ;
...
#ifdef DEBUG                                                                                                            
        printf("pos:%d  hide:%d %lf\n", currTrainSample_pos, hidelayer_pos, hideLayer[hidelayer_pos].value);   
#endif                                                                                                                  
			}
			...
			for(outputlayer_pos = 0; outputlayer_pos < OUTPUT_NODE; outputlayer_pos++)
			{
      		...
      		printf("pos:%d  hide[%d] -> output[%d]:value:%lf weight:%lf\n", currTrainSample_pos, hidelayer_pos, outputlayer_pos, 
								...
								hideLayer[hidelayer_pos].weight[outputlayer_pos]);     
#endif                                                                   
				}
#ifdef DEBUG                                                                                            
...
#ifdef DEBUG                                                             
      printf("pos:%d hide:%d bp weight:%lf\n", currTrainSample_pos, hidelayer_pos, hideLayer[hidelayer_pos].weight_delta);     
#endif                                                                   
				}
			}
...
#ifdef DEBUG                                                             
      printf("pos:%d hide:%d bp bias_delta:%lf param:%lf\n", currTrainSample_pos, hidelayer_pos, hideLayer[hidelayer_pos].bias_delta, hideLayer[hidelayer_pos].d_param);     
#endif                                                                   
			}
...
#ifdef DEBUG                                                         
          printf("[%d]hide row:%d weight %lf bias %lf\n",     
              __LINE__,                                              
              hidelayer_pos,                                         
              hideLayer[hidelayer_pos].weight[outputlayer_pos],                 
              hideLayer[hidelayer_pos].bias);                     
#endif                                                               
			}
